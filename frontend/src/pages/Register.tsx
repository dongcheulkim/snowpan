      ...
      <div className="card p-6 sm:p-8">
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs"><span className="px-3 bg-white text-gray-500">간편 회원가입</span></div>
          </div>
          <div className="flex gap-3 mt-4">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 3c-5.088 0-9.2 3.272-9.2 7.313 0 2.604 1.716 4.9 4.318 6.195-.19.71-.69 2.577-.79 2.975-.124.496.18.49.38.355.157-.105 2.5-1.7 3.533-2.392.572.083 1.158.126 1.759.126 5.088 0 9.2-3.272 9.2-7.313S17.088 3 12 3z"/></svg>
              카카오
            </button>
            <button
              type="button"
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M16.273 12.845L7.376 0H0v24h7.727V11.155L16.624 24H24V0h-7.727z" transform="scale(0.75) translate(4,4)"/></svg>
              네이버
            </button>
          </div>
        </div>

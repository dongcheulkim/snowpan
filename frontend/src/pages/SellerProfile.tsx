  ...
  return (
    <div className="max-w-md mx-auto space-y-5 animate-fade-in">
      ...
      <div className="glass rounded-2xl p-6 text-center">
        <div className="w-20 h-20 rounded-full bg-gradient-to-br from-neon-green to-emerald-500 flex items-center justify-center text-3xl mx-auto mb-4">
          👤
        </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="py-3 bg-white/5 rounded-xl">
          ...
          {seller.items.map((item) => (
            ...
            >
              ...
              <div className="flex-1">
                ...
                <div className="text-sm font-bold text-neon-green">{item.price.toLocaleString()}원</div>
              </div>

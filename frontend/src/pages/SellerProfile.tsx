    ...
    <div className="max-w-md mx-auto space-y-5 animate-fade-in">
      ...
      <div className={`card rounded-2xl p-6 text-center ${seller.highlighted ? 'ring-2 ring-amber-300 bg-gradient-to-b from-amber-50/60 to-white' : ''}`}>
        ...
        {user && user.id === sellerId && (
          <div className="mt-3">
            <Link to="/mypage/edit" className="inline-block px-5 py-2 bg-accent text-white rounded-lg text-xs font-bold hover:bg-accent-light transition-colors">프로필 수정</Link>
          </div>
        )}
        {user && user.id !== sellerId && (

  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <div>
        ...
        <label className={`block w-full py-4 border-2 border-dashed rounded-lg text-center text-xs cursor-pointer transition-all ${certFile ? 'border-primary/50 text-primary bg-primary/5' : 'border-gray-200 text-gray-500 hover:border-primary/50'}`}>

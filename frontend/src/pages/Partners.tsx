...
const FAQ = [
  ...
  { q: '직원이 대신 관리해도 되나요?', a: '네. 사장님 대시보드의 매장 카드에서 "직원" → "초대 링크 만들기"로 링크를 만들어 직원에게 보내면, 직원이 자기 계정으로 참여해 예약 확정·매장 정보 수정·소식·리뷰 답글·광고 신청을 함께 할 수 있습니다. 매장으로 온 손님 문의 채팅도 함께 보고 답할 수 있습니다. 매장 삭제와 직원 추가·해제는 사장님만 할 수 있습니다.' },
    ...
    <div className="max-w-md mx-auto space-y-6 animate-fade-in">
      ...
      <section className="card p-5">
        ...
        <ul className="text-xs text-gray-600 leading-relaxed space-y-1">
          ...
          <li>· 직원 계정 초대 — 초대 링크로 직원을 붙이면 예약 확인, 소식, 리뷰 답글, 광고 신청까지 함께 관리</li>
        </ul>

...
const RentalDetail = () => {
  ...
  if (!item) {
    return (
      <div className="text-center py-20 animate-fade-in">
        ...
        <Link to="/rental" className="text-gray-400 hover:text-gray-900 text-sm">← 목록으로 돌아가기</Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
      <Link to="/rental" className="inline-flex items-center gap-2 text-gray-400 hover:text-gray-900 text-sm transition-colors">← 렌탈 목록</Link>
      ...
      <div className="card rounded-2xl p-5">
        ...
        <div className="text-xs text-gray-400 mt-1">{item.duration} 기준</div>
      </div>

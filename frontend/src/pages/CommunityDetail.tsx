...
const CommunityDetail = () => {
  ...
  const posts: Record<string, {
    ...
    '4': {
      ...
      comments: [
        ...
        { author: '스키입문', text: '부츠 피팅 팁 감사합니다.', time: '4시간 전' },
        { author: '프로강사', text: '부츠는 살짝 꽉 끼는게 정상이에요!', time: '3시간 전' },
      ],
    },
    '5': {
    ...
    '6': {
      ...
      comments: [
        { author: '시즌권러', text: '시즌권 사면 무조건 더 많이 감 ㅋㅋ', time: '9시간 전' },
        { author: '가끔러', text: '저는 일일권파... 시즌권 사면 의무감에 지칠 수 있어요', time: '8시간 전' },
      ],
    },
    '7': {
      ...
      comments: [
        { author: '보드입문', text: '저도 Step On 쓰는데 편한 건 인정!', time: '11시간 전' },
      ],
    },
    '8': {
  ...
  if (!post) {
    return (
      <div className="text-center py-20 animate-fade-in">
        ...
        <Link to="/community" className="text-gray-400 hover:text-white text-sm">← 커뮤니티로 돌아가기</Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5 animate-fade-in">
      <Link to="/community" className="inline-flex items-center text-gray-500 hover:text-white text-sm transition-colors">
        ← 커뮤니티
      </Link>
      ...
      <div className="card rounded-lg p-6">
        ...
        <div className="flex items-center gap-3 mb-5 pb-5 border-b border-white/5">
          ...
          <span className="text-[11px] text-gray-600">· 조회 {post.views}</span>
        </div>
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium transition-all active:scale-95 ${
              liked
                ...
                : 'bg-[#111] text-gray-400 border border-white/5 hover:bg-[#1a1a1a]'
            }`}
          >
            좋아요 {likeCount}
          </button>
      ...
      <div className="card rounded-lg p-5">
        ...
        <div className="space-y-4">
          {comments.map((comment, idx) => (
            <div key={idx} className="flex gap-3">
              <div className="w-7 h-7 rounded-full bg-[#1a1a1a] flex items-center justify-center text-[10px] flex-shrink-0 mt-0.5">👤</div>
        ...
        <div className="flex gap-2 mt-5 pt-4 border-t border-white/5">
          <input
            ...
            className="flex-1 px-4 py-2.5 bg-[#0a0a0a] border border-white/10 rounded-lg text-sm text-white placeholder-gray-600 focus:outline-none focus:border-white/20 transition-all"
          />
          <button

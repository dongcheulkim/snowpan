    ...
    <div className="max-w-md mx-auto space-y-5 animate-fade-in">
      ...
      <section className="card p-5 space-y-2">
        ...
        <ul className="text-xs text-gray-700 leading-relaxed list-disc pl-4 space-y-1">
          <li>이메일, 전화번호, 이름, 닉네임, 프로필 사진, 푸시 알림 토큰 등 개인 식별 정보는 다른 이용자에게 보이는 곳에서 즉시 익명값으로 바뀝니다.</li>
          ...
          <li>작성한 커뮤니티 글·댓글·투표, 매장 소식, 매장 후기, 자격증 신청, 찜·키워드 알림, 판매 중이거나 예약 중인 중고 매물은 모두 삭제됩니다(복구 불가). 다른 사람의 답글이 달린 댓글은 답글을 위해 "삭제된 댓글입니다"로만 남습니다. 직접 등록한 매장·레슨·숙소·여행사도 삭제되며, 기존 매장의 소유권을 넘겨받은 경우 그 매장은 운영진 관리로 되돌아갑니다.</li>
        </ul>
      </section>
      ...
      <section className="card p-5 space-y-2">
        ...
        <ul className="text-xs text-gray-700 leading-relaxed list-disc pl-4 space-y-1">
          ...
          <li>이름, 이메일, 전화번호, 소셜 로그인 식별자(카카오·네이버·애플 회원번호)는 사기·분쟁 대응과 수사기관 협조를 위해 운영자만 볼 수 있는 곳에 5년간 보관한 뒤 삭제됩니다. 다른 이용자에게는 보이지 않습니다.</li>
          <li>채팅 내역, 판매 완료된 거래 기록, 받은 거래 후기, 신고 기록은 거래 상대방 보호와 사기·분쟁 대응을 위해 작성자가 "탈퇴한 회원"으로 표시된 익명 상태로 남습니다.</li>
          <li>로그인 기록(접속 IP·기기 정보)은 사기 신고 대응을 위해 90일간 보관 후 자동 삭제됩니다.</li>
        </ul>

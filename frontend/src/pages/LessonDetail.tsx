...
const LessonDetail = () => {
  ...
  const allItems: Record<string, {
    ...
    '2': {
      ...
      level: 'intermediate', levelText: '중급', maxStudents: 1, image: '⛷️',
    ...
    '3': {
      ...
      level: 'beginner', levelText: '초급', maxStudents: 6, image: '🏂',
    ...
    '4': {
      ...
      level: 'intermediate', levelText: '중급', maxStudents: 1, image: '🏂',
    ...
    '5': {
      id: '5', name: '스키 상급반', resort: '하이원', price: 200000, duration: '3시간',
      level: 'advanced', levelText: '상급', maxStudents: 4, image: '⛷️',
      instructor: '정강사 (데모팀 출신)',
      description: '상급자를 위한 고급 기술 클리닉. 급사면 카빙, 모글, 오프피스테 등 고난도 기술을 연마합니다.',
    ...
    '6': {
      ...
      level: 'beginner', levelText: '초급', maxStudents: 8, image: '🏂',

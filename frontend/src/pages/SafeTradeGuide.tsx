  ...
  return (
    <div className="max-w-2xl mx-auto space-y-5 animate-fade-in">
      ...
      <div className="card p-5 bg-coral/5 border-coral/20">
        <h2 className="text-base font-bold text-coral mb-2">⚠️ 스노우판은 책임지지 않습니다</h2>
      ...
      <div className="text-center pb-4">
        <Link to="/mypage/support" className="text-sm text-sky-600 font-medium hover:underline">

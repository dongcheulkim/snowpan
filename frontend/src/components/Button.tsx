...
const variantClass: Record<Variant, string> = {
  ...
  secondary: 'bg-snow text-gray-900 border border-gray-300 hover:border-gray-900 hover:bg-gray-50 active:bg-gray-100 disabled:bg-gray-50 disabled:text-gray-600',

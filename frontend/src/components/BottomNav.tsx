...
const BottomNav = () => {
  ...
  return (
    <nav
      ...
      className={`md:hidden fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md z-40 bg-white/95 backdrop-blur-md border-t border-gray-200 safe-area-bottom transition-transform duration-200 ${

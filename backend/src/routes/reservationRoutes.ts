...
import {
  ...
  confirmReservation,
  declineReservation,
  cancelReservation, hideReservation, setWorkStatus } from '../controllers/reservationController';
...
router.put('/:id/work-status', authenticateToken, validateUUIDParam('id'), setWorkStatus); // 정비샵 작업 현황 (2026-09-24)

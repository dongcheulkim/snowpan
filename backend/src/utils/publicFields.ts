...
const PRIVATE_KEYS = ['businessLicense', 'instructorCert', 'accommodationPermit', 'aiNote', 'aiReviewedAt', 'aiVerified', 'extraKindsProof', 'providerType'] as const; // providerType: 레슨 소속(개인 강사/사업자) — 관리자·본인만

...
// 미설정 시 프로덕션=pansports.vercel.app + 이전 snowpan.vercel.app (전환 기간 동안 호환), dev=localhost
const DEFAULT_ALLOWED_ORIGINS = process.env.NODE_ENV === 'production'
  ? ['https://pansports.vercel.app', 'https://snowpan.vercel.app']
...
// CSP 는 frontend 가 별도 도메인 (pansports.vercel.app) 이고 API 만 서빙하므로
